...
police theirs** (see CLAUDE.md "Scope discipline").
...
into anything that *sources* it. See the "Client CLI" section of CLAUDE.md before
touching `mdnest`.
...
Run the tier that matches the change (see CLAUDE.md "Testing"): `cli-unit.sh` +
